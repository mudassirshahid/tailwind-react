...
export function LandinngPageOne() {
  ...
  return (
    <div className="w-full">
      <header className="relative w-full border-b bg-white pb-4 sticky top-0 z-50">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2">
          ...
          {isMenuOpen && (
            <div className="absolute inset-x-0 top-0 z-50 origin-top-right transform p-2:md transition lg:hidden">
